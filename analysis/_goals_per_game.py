...
for year in range(1918, 2017)[:]:
    ...
    # subtracting number of shootout wins as these aren't official goals
    ...
    games_goals_per_year[season]['year'] = year
    games_goals_per_year[season]['games'] = season_games_played
    games_goals_per_year[season]['goals'] = season_goals_scored
    games_goals_per_year[season]['goals_per_game'] = round(
...
games_goals_per_year['overall']['games'] = overall_sum_games_played
games_goals_per_year['overall']['goals'] = overall_sum_goals_scored
games_goals_per_year['overall']['goals_per_game'] = overall_goals_per_game
